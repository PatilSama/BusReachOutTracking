...
//                                    Toast.makeText(context, ""+listKmUpdate.get(dksLng)/busSpeedCount, Toast.LENGTH_SHORT).show();
                                } else {
                ...
                listDistKM.setAdapter(new KmsList(context,time,listKmUpdate));
